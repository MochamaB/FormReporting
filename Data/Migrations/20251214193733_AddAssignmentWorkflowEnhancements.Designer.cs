...
namespace FormReporting.Data.Migrations
{
    ...
    [Migration("20251214193733_AddAssignmentWorkflowEnhancements")]
    partial class AddAssignmentWorkflowEnhancements
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FormReporting.Models.Entities.Forms.FormTemplateAssignment", b =>
                {
                    ...
                    b.Property<int?>("RecurrenceDayOf")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DueDate")
                        .HasDatabaseName("IX_TemplateAssignment_DueDate");

                    b.HasIndex("IsRecurring")
                        .HasDatabaseName("IX_TemplateAssignment_Recurring")
                    ...
                    b.HasIndex("ReportingYear", "ReportingMonth")
                        .HasDatabaseName("IX_TemplateAssignment_ReportingPeriod");
                    ...
                    b.HasIndex("TemplateId", "Status", "DueDate")
                        .HasDatabaseName("IX_TemplateAssignment_Template_Status_Due");

                    b.ToTable("FormTemplateAssignments", t =>
                        {
                            t.HasCheckConstraint("CK_TemplateAssignment_RecurrencePattern", "RecurrencePattern IS NULL OR RecurrencePattern IN ('Daily', 'Weekly', 'Monthly', 'Quarterly', 'Annually')");

                            t.HasCheckConstraint("CK_TemplateAssignment_Status", "Status IN ('Pending', 'InProgress', 'Completed', 'Overdue', 'Cancelled')");
