...
namespace FormReporting.Data.Migrations
{
    ...
    [Migration("20251216220106_AddAssignmentModelChanges")]
    partial class AddAssignmentModelChanges
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FormReporting.Models.Entities.Forms.FormTemplateAssignment", b =>
                {
                    ...
                    b.HasIndex("Frequency")
                        .HasDatabaseName("IX_TemplateAssignment_Frequency");
                    ...
                    b.ToTable("FormTemplateAssignments", t =>
                        {
                            t.HasCheckConstraint("CK_TemplateAssignment_DueDay", "DueDay IS NULL OR (DueDay >= -1 AND DueDay <= 31)");

                            t.HasCheckConstraint("CK_TemplateAssignment_Frequency", "Frequency IS NULL OR Frequency IN ('Custom', 'Daily', 'Weekly', 'Monthly', 'Quarterly', 'Annually')");

                            t.HasCheckConstraint("CK_TemplateAssignment_GracePeriod", "GracePeriodDays >= 0");
